---
title: "How to Generate a Signed APK for the Google Play Store"
...
In this tutorial I'll show you how to make a signed release APK that can be uploaded to the play store.

I'll show you how to securely load in your gradle variables so that the project can be safely pushed to Git (something that is annoyingly not covered in other tutorials!).
...
## 3. Generate the Android bundle file manually
