...
excerpt: "Install, setup and start using the package by building a super simple track player music app. It will then be easy for you to use the react-native-track-player official docs to add extra options and functionality to make your app!"
featuredPost: false
keywords:
  [
    "100DaysOfCode",
...
In this tutorial I will show you how to install, setup and start using react-native-track-player by building a super-simple app.

It wins no style awards but I’ve kept this article short and sweet so you can get setup and get on with your day with minimal faff.
...
If you found this post helpful, say thanks by subscribing to [my YouTube channel](https://www.youtube.com/channel/UC0URylW_U4i26wN231yRqvA), I’d appreciate it a lot!
