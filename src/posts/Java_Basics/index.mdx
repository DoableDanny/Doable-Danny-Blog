...
You now understand the basics of the Java programming language. Next steps would be to build a simple Java project, and learn Object Oriented Programming in Java.
