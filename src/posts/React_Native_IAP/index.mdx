...
excerpt: "I’ve decided to cover every single step in detail. From setting up your Google Play account, creating a signed APK for the store, adding Google Play in app products, to coding up a simple React Native app with an in-app purchase."
featuredPost: false
keywords:
  [
    "in-app purchase",
...
This tutorial was a lot of work, so if it was helpful, you can say thanks by subscribing to [my YouTube channel](https://www.youtube.com/channel/UC0URylW_U4i26wN231yRqvA) where I post coding tutorials. It would be much appreciated!
