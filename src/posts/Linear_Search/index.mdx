...
excerpt: "In this article we'll discuss Linear Search logic, the time and space complexity of Linear Search, and when to use Linear Search."
featuredPost: false
---
...
_Disclosure: I’m always looking for things I think my readers will value. If I make an affiliate partnership like the one featured in this article, then I may see a share of revenue._
