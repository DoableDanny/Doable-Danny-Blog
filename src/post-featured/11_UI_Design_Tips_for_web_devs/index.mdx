---
title: UI Design for Developers | 11 Easy Tips
slug: UI-Design-Tips-for-Web-Devs
date: 2020-09-23
featureImage: halacious-tZc3vjPCk-Q-unsplash.jpg
excerpt: "In the old days of the web, borders were everywhere. Nowadays, it’s better to not use them quite as much – it often looks cleaner."
featuredPost: true
---
...
![Consistent icon designs vs inconsistent icon designs](tip2.png)
...
![Bad clipart image of car vs quality image of car](tip1.png)
...
![Good contrast makes text easy to read](tip3.png)
...
![Too little vs good whitespace](tip4.jpg)
...
![Avoid times new roman and comic sans](tip6.png)
...
![Keep adding white creates tints](tip7.png)
...
![Border vs no border on a button](tip9.png)
...
![Underlined vs not underlined nav-bar links](tip10.png)
...
You can also find me on [Twitter](https://twitter.com/DoableDanny) and [YouTube](https://www.youtube.com/channel/UC0URylW_U4i26wN231yRqvA?sub_confirmation=1).
