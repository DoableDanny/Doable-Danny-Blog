...
const PrivacyPolicy = () => {
  return (
    <Layout thisPage={"home"}>
      ...
      >
        <h1 style={{ marginBottom: 40 }}>Privacy Policy</h1>
        ...
        <ol type="a">
          <li>
            ...
            materials (information or software) on doabledanny's web site for
          ...
          <li>
            ...
            these restrictions and may be terminated by doabledanny at any time.
        ...
        <ol type="a">
          <li>
            The materials on doabledanny's web site are provided "as is".
            doabledanny makes no warranties, expressed or implied, and hereby
            disclaims and negates all other warranties, including without
            limitation, implied warranties or conditions of merchantability,
            fitness for a particular purpose, or non-infringement of
            intellectual property or other violation of rights. Further,
            doabledanny does not warrant or make any representations concerning
        ...
        <p>
          In no event shall doabledanny or its suppliers be liable for any
          damages (including, without limitation, damages for loss of data or
          profit, or due to business interruption,) arising out of the use or
          inability to use the materials on doabledanny's Internet site, even if
          doabledanny or a doabledanny authorized representative has been
        ...
        <p>
          The materials appearing on doabledanny's web site could include
          technical, typographical, or photographic errors. doabledanny does not
          warrant that any of the materials on its web site are accurate,
          complete, or current. doabledanny may make changes to the materials
          contained on its web site at any time without notice. doabledanny does
        ...
        <p>
          doabledanny has not reviewed all of the sites linked to its Internet
          web site and is not responsible for the contents of any such linked
          site. The inclusion of any link does not imply endorsement by
          doabledanny of the site. Use of any such linked web site is at the
          user's own risk.
        </p>
        ...
        <p>
          doabledanny may revise these terms of use for its web site at any time
        ...
        <p>
          Any claim relating to doabledanny's web site shall be governed by the
          laws of the State of UK without regard to its conflict of law
          provisions.
        </p>
